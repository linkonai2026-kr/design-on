...
현재 **v4.1.0**입니다. 무엇이 바뀌었는지는 [CHANGELOG.md](CHANGELOG.md)에 정리해 두었습니다.
...
**여기서 묻는 건 이게 전부입니다.** 페이지 구조, 글꼴 조합, 여백, 사진, 문구는 묻지 않습니다. 저장소 안에 넣어둔 구조 10종·팔레트 83세트·서체 페어링 9종·사진 레시피에서 **답하신 내용에 맞는 것을 골라 알아서 조립합니다.** 그래서 질문이 세 개로 끝납니다.
...
| 컬러 팔레트 | **83세트** | 정확한 HEX 색상값 369개, 어울리는 업종 |
...
├── data/palettes.json       컬러 팔레트 83세트
